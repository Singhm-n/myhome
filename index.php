...
<header class="bgimg-1 w3-display-container w3-grayscale-min" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
   <span class="w3-jumbo w3-hide-small">Build your home with MyHome</span><br>
    ...
    <p><a href="signup.php" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-off">Register with us now!</a></p>
  </div>
...
<div class="w3-container w3-light-grey" style="padding:128px 10px">
  <div class="w3-row-padding">
    <div class="w3-col m6">
      ...
      <p><a href="bedroom.html" class="w3-button w3-black"><i class="fa fa-th"> </i> BEDROOM</a></p>
    </div>
    <div class="w3-col m6">
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="contact">
  ...
  <div style="margin-top:48px">
    ...
    <button class="open-button" onclick="Formop()">Feedback</button>
...
<div class="form-popup" id="myForm">
  <form action="index.php" class="form-container" method="POST">
    ...
    <input type="text" placeholder="Enter Email" name="email12" required>
