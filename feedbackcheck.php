...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="feedbackcheck.php" class="w3-bar-item w3-button w3-padding w3-blue " id="feed"><i class="fa fa-envelope"></i>  Feedback</a>
  ...
  <div class="w3-twothird">
          ...
          <table class="w3-table w3-striped w3-white">
            ...
            <tr>
              ...
              <td><a href="deletefeed.php?id=<?php echo $row['id']; ?>">Delete</a></td>
              <tr>
              <?php } ?>
          </table>
        </div>
